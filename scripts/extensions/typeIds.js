export const typeIdToID = new Map([
  ...
  ["minecraft:brown_bundle", 257],
  ["minecraft:gray_bundle", 258],
  ["minecraft:cyan_bundle", 259],
  ["minecraft:light_gray_bundle", 260],
  ["minecraft:yellow_bundle", 261],
  ["minecraft:pink_bundle", 262],
  ["minecraft:green_bundle", 263],
  ["minecraft:white_bundle", 264],
  ["minecraft:blue_bundle", 265],
  ["minecraft:bundle", 266],
  ["minecraft:magenta_bundle", 267],
  ["minecraft:purple_bundle", 268],
  ["minecraft:light_blue_bundle", 269],
  ["minecraft:lime_bundle", 270],
  ["minecraft:black_bundle", 271],
  ["minecraft:orange_bundle", 272],
  ["minecraft:red_bundle", 273],
  ["minecraft:breeze_rod", 274],
  ["minecraft:wind_charge", 275],
  ["minecraft:ominous_trial_key", 276],
  ["minecraft:trial_key", 277],
  ["minecraft:apple", 278],
  ...
  ["minecraft:skull", 737],
  ["minecraft:stained_hardened_clay", 738],
